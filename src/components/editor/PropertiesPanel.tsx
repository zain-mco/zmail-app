            ...
            {currentSrc && onAltChange && (
                <div>
                    <div className="flex items-center gap-1 mb-1">
                        <Label className="text-xs font-medium text-gray-600">Image Description (Alt text)</Label>
                        <span className="text-amber-500 text-xs">*</span>
                        <span className="text-[9px] text-gray-400 italic ml-auto">Required for export</span>
                    </div>
                    <Input
                        value={currentAlt || ""}
                        onChange={(e) => onAltChange(e.target.value)}
                        placeholder="Describe what's in this image..."
                        className={`text-xs ${!currentAlt?.trim() ? 'border-amber-300 bg-amber-50/50 focus:border-amber-400' : ''}`}
                    />
                    {!currentAlt?.trim() && (
                        <p className="text-[10px] text-amber-600 mt-1 flex items-center gap-1">
                            ...
                            Please add a description to help with email deliverability
                        </p>
                    )}
                </div>
            )}
